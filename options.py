class TrainingOptions:
    ...
    def __init__(self,
                 ...
                 train_folder: str,me_train_folder:str, runs_folder: str,
                 start_epoch: int, experiment_name: str):
        self.batch_size = batch_size
        self.number_of_epochs = number_of_epochs
        self.train_folder = train_folder
        self.me_train_folder = me_train_folder
...
class HiDDenConfiguration():
    ...
    def __init__(self, H: int, W: int, message_length: int,learning_rate: int,
        ...
        self.me_decoder_loss = me_decoder_loss
        self.adversarial_loss = adversarial_loss
        self.enable_fp16 = enable_fp16
        self.noise_feature = noise_feature          #补充
